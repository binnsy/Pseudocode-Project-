...
print "Spring has sprung and adventure awaits. \nYour goal in this adventure is to make it to the cabin at the top of the mountain before night. \nThis is a 20 mile hike, so do not rush, but be careful how you use your time. \n Be ware of the heavy flowing rivers, fresh spring snowfall, animals, and other obstacles that you may encounter. \nChoose the path that you think it the best fit. \n"   
...
def accept_the_journey(): 
    ...
    print name +", you have accepted this journey. Now you have two paths to choose from: \nTerrible Terrain or Simply Safer."
