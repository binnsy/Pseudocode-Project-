...
def obstacle_three_TT():
    ...
    if obstacle_three_TT == "pond":
        ...
        print"                    GAME OVER\n"
        return True
        """return True asks to start a new game or exit"""
...
def obstacle_four_TT():
    """this is the fourth obstacle the user will come across"""
...
def obstacle_five_TT():
    """this is the fifth obstacle the user will come across"""
...
def made_it_to_the_top_TT():
    """the user made it to the top and completed the game"""
...
"""SIMPLY SAFERRRRRRRRR ROUTE"""

def obstacle_one_SS():
    """this is the first obstacle the user will come across in SS route"""
...
def obstacle_two_SS():
    """this is the second obstacle the user will come across in SS route"""
...
def obstacle_two_SS_cross_bridge():
    """this is part two of the second obstacle the user will come across in SS route"""
...
def obstacle_three_SS():
    """this is the third obstacle the user will come across in SS route"""
...
def obstacle_four_SS():
    """this is the fourth obstacle the user will come across in SS route"""
...
def made_it_to_the_top_SS():
    """the user has completed the course and made it to the top of the mountain"""
